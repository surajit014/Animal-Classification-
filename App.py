...
# model = load_model('D:/Animal/model.h5')

# # Define the classes (replace with your actual class names)
# CLASS_NAMES = ['Bear', 'Bird', 'Cat', 'Cow', 'Deer', 'Dog', 'Dolphin', 'Elephant', 'Giraffe', 'Horse', 'Kangaroo', 'Lion', 'Panda', 'Tiger', 'Zebra']  # Example classes
